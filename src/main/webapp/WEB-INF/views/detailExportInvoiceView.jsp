    ...
    <div class="detail-container">
        <div id="invoice" style="padding: 2rem; display: flex; flex-direction: column; gap: 1.5rem; border: .1rem gray solid;">
            <h2 style="font-size: 2.5rem;
                       ...
                       font-weight: bold;
                       text-align: center;">Hóa đơn xuất</h2>
            ...
            <table class="detail-table" style="border: solid .1rem gray; width: 100%; overflow: auto; border-collapse: collapse;">
                ...
                <c:forEach items="${productList}" var="product">
                    <tr>
                        ...
                        <td style="font-size: 1.5rem; padding: 1rem; border: solid .1rem gray; text-align: center;">${product.price}</td>
        ...
        <div class="button-group">
            ...
            <a href="${pageContext.request.contextPath}/invoice/export/list">Quay lại</a>
        </div>
